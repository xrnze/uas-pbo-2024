...
public class Hrd {
    ...
    private int transport = 750000;
    private int lembur = 7500;
    private int tunjanganIstri = 250000;
    private int tunjanganAnak = 90000 ;
    private int tunjanganAnak2 = 190000;
    private String kode =  "HRD";
