...
public class Supervisor extends Pegawai {
    private int gajiPokok = 10000000;
    private int transport = 1000000;
    private int lembur = 10000;
    private int tunjanganIstri = 300000;
    private int tunjanganAnak = 100000 ;
    private int tunjanganAnak2 = 200000;
    private String kode =  "SPV";
